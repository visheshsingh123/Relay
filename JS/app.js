...
(() => {
  ...
  const conversations = [
    ...
    },
    {
      ...
      unread: 0,
      messages: [
        { from: "them", text: "Shipping the release tonight.", time: "9:02 AM" },
        { from: "me", text: "Nice, I'll keep an eye on the logs.", time: "9:05 AM", read: true },
      ],
    },
    {
      id: "c3",
      ...
      unread: 0,
      messages: [
        { from: "them", text: "Thanks for the quick turnaround yesterday.", time: "Yesterday" },
        { from: "me", text: "Anytime — let me know if anything else comes up.", time: "Yesterday", read: true },
      ],
    },
    {
      id: "c4",
      ...
      unread: 5,
      messages: [
        { from: "them", text: "Are we still on for Friday?", time: "Mon" },
      ],
    },
  ];
